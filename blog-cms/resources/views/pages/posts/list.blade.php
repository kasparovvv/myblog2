...
<script>
    $(document).ready(function() {
        ...
        var postListTable = $('#example').DataTable({
            "processing": true,
            "serverSide": true,
            // "bInfo": false,
            //"ordering": false,
        ...
        function renderEditButton(id){
            var button = `<a type="button" href="{{url('post/edit/${id}')}}" class="btn btn-primary btn-sm shadow delete_button">Edit</a>`;
            return button;
        }
