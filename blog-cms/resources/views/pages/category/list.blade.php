...
<script>
    $(document).ready(function() {
        ...
        var categoryListTable = $('#example').DataTable({
            "processing": true,
            "serverSide": true,
            // "bInfo": false,
            //"ordering": false,
            "lengthChange": false,
            "ajax": {
                "url": "{{url('category/list_category')}}",
                "type": "POST",
                data: {
                    _token: "{{ csrf_token() }}"
                }
        ...
        function renderEditButton(id){
            var button = `<a type="button" href="{{url('category/edit/${id}')}}" class="btn btn-primary btn-sm shadow delete_button">Edit</a>`;
            return button;
        }
        ...
        $(document).on("click",".delete_button",function() {
            ...
            deleteCategory(id,job);
        });

       
        function deleteCategory(id,job){
